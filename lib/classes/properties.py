class BaseProperties:
    ...
    def __init__(self):
        ...
        self.props_container['streaming_endpoint'] = "https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=1&sort_by=vote_count.desc&watch_region=US&with_watch_monetization_types=flatrate&with_original_language=en"
